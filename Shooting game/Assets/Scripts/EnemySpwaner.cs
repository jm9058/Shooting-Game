...
public class EnemySpwaner : MonoBehaviour
{
 [SerializeField]
    ...
    [SerializeField]
    private Transform       canvasTransform;        // UI를 표현하는 Cansvas 오브젝트의 Transform
    [SerializeField]
    private BGMController   bgmCountroller;         // 배경음악 설정 (보스 등장 시 변경)
    [SerializeField]
    ...
    private void SpawnEnemyHPSlider(GameObject enemy)
    {
        ...
        sliderClone.GetComponent<SliderPosiotionAutoSetter>().Setup(enemy.transform);
    ...
    {
        // 보스 등장 BGM 설정 
        bgmCountroller.ChangeBGM(BGMType.Boss);  // bgmCountroller.ChangeBGM(1); 보다 가독성이 좋다.
        // 보스 등장 텍스트 활성화
